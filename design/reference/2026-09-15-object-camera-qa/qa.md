...
- The 18 pre-existing `physical-touch-*.png` leftovers were 632×1392 Mac-side/mirrored mobile-browser frames, including visual-diff and retry artifacts. They were not verified Safari touch receipts, so they were removed rather than retained under a misleading name.
